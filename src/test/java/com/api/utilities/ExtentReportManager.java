...
public class ExtentReportManager implements ITestListener{
	...
	public void configureReport()
	{
		...
		String reportName = "ReqResTestReport-" + timestamp + ".html";
		...
		htmlReporter.config().setDocumentTitle("ResReqAutomationReport");
		htmlReporter.config().setReportName("ReqRes_API");
